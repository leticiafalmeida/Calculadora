      ...
      if (!isDev && isClient && config.plugins) {
        config.plugins.push(
          new JavascriptObfuscator({
            ...
            deadCodeInjection: false, // This option greatly increases the size of obfuscated code (up to 200%) This feature adds random dead code blocks (ie: code that will not be executed) to the obfuscated output, making it more difficult to reverse engineer.
            deadCodeInjectionThreshold: 0.5,
            debugProtection: false, // Debugging protection If you open the developer tools, you can freeze your browser.
            debugProtectionInterval: false, // If checked, the interval forced debugging mode is used on the "Console" tab, which makes it more difficult to use other functions of "Developer Tools". How does it work? A special code that calls the debugger; inserted repeatedly throughout the obfuscated source code.
            ...
            stringArrayEncoding: [], // This option may slightly reduce the script speed. Use Base64 or RC4 to encode all string literals of stringArray and insert a special function to decode it back at runtime.
